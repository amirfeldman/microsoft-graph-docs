...
description: "Retrieve the properties of an health issue object."
ms.date: 19/03/2024
author: "NaamaAlmog"
...
Get the properties of an [health issue](../resources/security-identities-healthIssue.md) in an organization based on the specified healthIssue **id** property.
...
If successful, this method returns a `200 OK` response code and an [healthIssue](../resources/security-identities-healthIssue.md) object in the response body.
...
-->
``` http
GET https://graph.microsoft.com/beta/security/identities/healthIssues/da637578995287051192_756343937
```
